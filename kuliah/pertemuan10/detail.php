      ...
      <div class="latar bg-white">
        <div class="row">
          ...
          <div class="col mt-5 pt-5">
            ...
            <a href="latihan3.php" type="button" class="btn btn-primary mt-2">Kembali</a>
            <a href="#" type="button" class="btn btn-info mt-2">Edit</a>
            <a href="#" type="button" class="btn btn-danger mt-2">Hapus</a>
            </div>
          </div>
        </div>
      </div>
