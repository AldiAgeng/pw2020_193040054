...
<html lang="en">
  ...
  <div class="container">
    <div class="row mt-5">
      ...
      <h3><i class="fas fa-users-cog mr-2"></i> TAMBAH ADMIN</a></h3><hr>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_admin" class="form-control" id="nama_admin" placeholder="Nama Admin" autocomplete="off" required>
        </div>
        <div class="form-group">
          <label for="no_hp">No HP</label>
          <input type="text" name="no_hp" class="form-control" id="no_hp" placeholder="No HP" autocomplete="off" required>
        </div>
